...
const servicePackages = [
  { level: "Level 1", price: "$119.99", recommendation: "Recommended Every 30 Hours", description: "Everything Torqued, Aligned & Adjusted", features: ["Torque All Fasteners", "Align & Adjust Breaks", "Align & Adjust Shifting", "Adjust Headset", "Inspect Bottom Bracket", "Bike Wash"] },
  { level: "Level 2", price: "$169.99", recommendation: "Recommended Every 50 Hours", description: "Everything Cleaned, Tensioned & Aligned", features: ["Level 1 +", "Drive Train Removed For Deep Clean", "Lateral & Vertical Wheel True"] },
  { level: "Level 3", price: "$369.99", recommendation: "Recommended Every 100 Hours", description: "The Entire Bike Stripped, Cleaned & Tuned To Perfection", features: ["Level 2 +", "Complete Tear Down & Deep Clean of All Parts", "Full Bearing Rebuild For Non-Functioning Bearings", "Reassemble bike and lube all parts", "Replace All Cable & Housing"] },
];

const reviews = [
  { text: "The bike service team at Steamboat did an incredible job with my Trek. The suspension feels better than when it was new!", author: "Mike R.", rating: 5 },
  { text: "Professional service and amazing attention to detail. These guys really know their stuff when it comes to bike maintenance.", author: "Sarah L.", rating: 5 },
  { text: "Best bike shop in Steamboat! They completely restored my mountain bike and the service was outstanding.", author: "Tom K.", rating: 5 },
];
        ...
        <div className="container-custom py-16">
          ...
          <div className="bg-gray-50 rounded-lg p-8 mb-12">
            <div className="flex items-start space-x-4 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-bold text-steamboat-darkBlue mb-3">
                  Expert Bike Technicians
                </h2>
