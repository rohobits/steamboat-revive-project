...
const downtownPackages = [
  {
    ...
    includes: [
      "Boots - sport boot package",
      "Poles - basic pole package",
    ],
  ...
  },
  {
    ...
    includes: [
      "Boots - premium A/T boot package",
      "Poles - adjustable pole package",
      "Skins - essential for backcountry hikes",
    ],
    ...
    <>
      ...
      <div className="container-custom py-16">
            ...
            <Card key={idx} className="border-2">
              <CardContent className="p-6">
                ...
                {pkg.link ? (
                  ...
                  <button className="inline-block px-4 py-2 bg-steamboat-blue text-white font-semibold rounded hover:bg-steamboat-lightBlue transition">
                    {pkg.callToAction}
                  </button>
                )}
              </CardContent>
        ...
        <section className="mb-16">
          ...
          <p>442 Lincoln Ave<br />Steamboat Springs, CO 80487</p>
          <p>
            <a
              href="tel:9708799144"
